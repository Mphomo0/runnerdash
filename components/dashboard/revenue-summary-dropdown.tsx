  ...
  const stats = [
    {
      ...
      subtext: `R${runnerRevenue.toFixed(2)} runners + R${ordersRevenue.toFixed(2)} orders`,
      icon: DollarSign,
    ...
    },
    {
      label: "Active Orders",
      value: `${activeOrders}`,
      subtext: `${ordersToBuy} waiting to buy`,
      icon: ShoppingCart,
        ...
        <div className="grid grid-cols-2 md:grid-cols-4">
          {stats.map((stat, index) => (
            <div
              ...
              style={{
                borderBottom:
                  index < 4 ? "1px solid var(--border-subtle)" : "none",
                borderRight:
                  index % 2 === 0 ? "1px solid var(--border-subtle)" : "none",
              }}
            >
