...
import { createRunnerFeeTier, deleteRunnerFeeTier } from "@/app/actions/settings"
            ...
            <TableBody>
              {initialTiers.map((tier) => (
                <TableRow key={tier.id}>
                  ...
                  <TableCell>
                    <Button variant="ghost" size="icon" onClick={() => handleDelete(tier.id)} className="text-red-500 hover:text-red-700 hover:bg-red-100">
          ...
          <form onSubmit={handleAdd} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  onChange={(e) => setNewTier({...newTier, minItems: e.target.value})}
                  required 
                />
              </div>
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  onChange={(e) => setNewTier({...newTier, maxItems: e.target.value})}
                  required 
                />
              </div>
            </div>
            <div className="space-y-2">
              ...
              <Input 
                ...
                onChange={(e) => setNewTier({...newTier, feeAmount: e.target.value})}
                required 
              />
            </div>
            <Button type="submit" disabled={loading} className="w-full" style={{ border: '1px solid white' }}>
