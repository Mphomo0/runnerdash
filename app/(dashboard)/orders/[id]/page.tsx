import { getOrder, deleteOrder, updateOrder } from "@/app/actions/orders"
...
import { ConfirmDeleteButton } from "@/components/orders/confirm-delete-button"
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between border-b pb-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <form action={async () => {
                  "use server"
                  await updateOrder(order.id, { itemsPaid: !order.itemsPaid })
                }}>
            ...
            <div className="flex items-center justify-between border-b pb-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <form action={async () => {
                  "use server"
                  await updateOrder(order.id, { runnerFeePaid: !order.runnerFeePaid })
                }}>
                  <Button size="sm" variant="ghost" type="submit">
